            ...
            <div
                ...
                <div className="absolute inset-0 bg-[#070707] opacity-60 ">
                    <div className="mt-25 ml-20 z-20">
                        <h1 className="font-bold text-6xl text-white ">Some Fun Facts About Us</h1>
                        <p className="font-bold text-2xl text-white mt-15">Praesent fermentum ligula in dui imperdiet, vel tempus nulla ultricies. Phasellus at commodo ligula. Nullam molestie volutpat sapien, a dignissim tortor laoreet quis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</p>
